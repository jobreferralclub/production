    ...
    <section className="relative min-h-screen flex items-center justify-center bg-black overflow-hidden pt-16 md:pt-20">
      ...
      <div className="relative z-10 container-custom text-center">
        ...
        >
          ...
          >
            Join a community that opens real doors at top companies. Connect with professionals, get quality referrals, and land high-impact roles.
          </motion.p>
          ...
          >
            <Button
              ...
              aria-label="Join JobReferral Club"
            >
              Sign In / Sign Up
