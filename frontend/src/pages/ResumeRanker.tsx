...
type LLMResult = {
    ...
    file_name: string;
    final_score: number;
    tech_skills_scores?: Record<string, number>;
...
const ResumeRanker: React.FC = () => {
    ...
    const [serverTechSkills, setServerTechSkills] = useState<string[]>([]);
    const [serverSoftSkills, setServerSoftSkills] = useState<string[]>([]);
    ...
    const features = [
        {
            ...
            description: "AI-powered evaluation of technical and soft skills with precision scoring"
        },
        {
            icon: "⚖️",
            title: "Custom",
        ...
        },
        {
            ...
            title: "Instant",
            subtitle: "Rankings",
            description: "Real-time candidate evaluation with comprehensive performance metrics"
        }
    ];
    ...
    const getRankBadgeStyle = (index: number) => {
        if (index === 0) return "bg-gradient-to-br from-[#79e708] to-[#5bb406] text-black font-black shadow-xl shadow-[#79e708]/40 border-2 border-[#79e708]/30";
        if (index === 1) return "bg-gradient-to-br from-gray-300 to-gray-500 text-black font-black shadow-xl shadow-gray-400/40 border-2 border-gray-300/30";
        if (index === 2) return "bg-gradient-to-br from-amber-400 to-orange-500 text-black font-black shadow-xl shadow-amber-400/40 border-2 border-amber-400/30";
