                ...
                <Layout>
                  ...
                  >
                    <Routes>
                      {/* Public routes */}
                      <Route path="/" element={<Landing />} />
                      <Route path="/login" element={isAuthenticated ? <Navigate to="/community/introductions" replace /> : <Login />} />
                      ...
                      {/* ✅ Community (flat routes, all start with /community/... ) */}
                      {isAuthenticated ? (
                        <>
